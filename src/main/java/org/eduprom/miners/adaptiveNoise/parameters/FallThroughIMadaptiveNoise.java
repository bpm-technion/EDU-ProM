package org.eduprom.miners.adaptiveNoise.parameters;
...
public class FallThroughIMadaptiveNoise implements FallThrough {

    public static class FallThroughActivityOncePerTraceConcurrent implements FallThrough {
    ...
    public static class FallThroughActivityConcurrent implements FallThrough {
	 ...
	 */
        ...
        public Node fallThrough(final IMLog log, final IMLogInfo logInfo, ProcessTree tree, final MinerState minerState) {
            ...
            final org.eduprom.miners.adaptiveNoise.parameters.FallThroughIMadaptiveNoise.FallThroughActivityConcurrent.CutWrapper cutWrapper = new CutWrapper();
    ...
    public static class FallThroughTauLoopStrict implements FallThrough {
    ...
    public static class FallThroughTauLoop implements FallThrough {
    ...
    public static class FallThroughFlowerWithoutEpsilon implements FallThrough {
    ...
    public static class FallThroughFlowerWithEpsilon implements FallThrough {
    ...
    private static List<FallThrough> fallThroughs = new ArrayList<FallThrough>(Arrays.asList(
            new FallThroughIMadaptiveNoise.FallThroughActivityOncePerTraceConcurrent(true),
            new FallThroughIMadaptiveNoise.FallThroughActivityConcurrent(),
            new FallThroughIMadaptiveNoise.FallThroughTauLoopStrict(),
            new FallThroughIMadaptiveNoise.FallThroughTauLoop(false),
            new FallThroughIMadaptiveNoise.FallThroughFlowerWithoutEpsilon(),
            new FallThroughIMadaptiveNoise.FallThroughFlowerWithEpsilon()
    ));
